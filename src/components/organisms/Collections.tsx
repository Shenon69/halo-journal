...
import CollectionForm from "../molecules/CollectionForm";
import useFetch from "@/hooks/useFetch";
import { Collection, createCollection } from "@/actions/collection";
import { toast } from "sonner";

const Collections = ({ collections = [], entriesByCollection }: { collections: any[], entriesByCollection: any }) => {
